...
This is a sample template for sam-puppeteer - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name sam-puppeteer --query 'Stacks[].Outputs'
```
